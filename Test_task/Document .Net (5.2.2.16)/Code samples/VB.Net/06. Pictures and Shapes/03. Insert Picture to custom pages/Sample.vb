...
Namespace Example
	Friend Class Program
		...
		Private Shared Sub InsertPictureToCustomPages()
			...
			Dim e1 As Element = dp.Pages(0).ElementsOnPage.FirstOrDefault(Function(e) TypeOf e Is Run)
			...
			If dp.Pages.Count >= 3 Then
				...
				Dim e2 As Element = dp.Pages(2).ElementsOnPage.FirstOrDefault(Function(e) TypeOf e Is Run)
